...
const makeExercise = (name: string, orderIndex: number, sets = 3, minReps = 8, maxReps = 12, restSeconds = 90) => ({
  ...
  cadence: "2-0-2",
  notes: orderIndex === 1 ? "Aquecimento progressivo antes da primeira serie valida." : "Tecnica limpa antes de carga."
});
...
export const demoPlan: WorkoutPlan = {
  ...
  userId: "demo-user",
  name: "Legado 6x",
  description: "Divisao demonstrativa para hipertrofia com domingo de descanso.",
  daysPerWeek: 6,
  isActive: true,
  days: [
    {
...
export const demoSessions: WorkoutSession[] = Array.from({ length: 18 }, (_, index) => ({
  ...
  notes: "Sessao demo registrada para alimentar historico e graficos.",
...
export const achievements: Achievement[] = [
  { id: "ach-1", title: "Primeiro treino", description: "A construcao saiu do papel.", unlockedAt: "2026-06-20" },
  { id: "ach-2", title: "10 treinos", description: "Constancia registrada.", unlockedAt: "2026-07-02" },
  { id: "ach-3", title: "Primeiro leg day concluido", description: "Ninguem gosta. Todo mundo precisa.", unlockedAt: "2026-07-04" },
  { id: "ach-4", title: "Primeiro recorde", description: "Mais capacidade, nao apenas numeros.", unlockedAt: "2026-07-09" }
];
...
export const lastWeeklyCheckin: WeeklyCheckin = {
  ...
  agendaChanged: false,
  recommendation: "Manter o plano e preservar recuperacao nas series acessorias."
};
