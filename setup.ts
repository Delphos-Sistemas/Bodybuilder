  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <Card className="space-y-4">
        ...
        {step === 4 && <p className="text-sand">Este aplicativo não substitui orientação médica, fisioterapêutica ou acompanhamento presencial de um profissional de educação física.</p>}
        {step === 5 && <Checklist items={["Academia completa", "Academia basica", "Treino em casa", "Somente halteres", "Peso corporal"]} />}
        {step === 6 && <p className="text-sand">Plano sugerido: Push, Pull, Legs, Push, Pull, Legs. Você pode editar antes de confirmar.</p>}
